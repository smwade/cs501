...
def weight_variable(shape, n=""):
    initial = tf.truncated_normal(shape, stddev=0.1, name=n)
    return tf.Variable(initial)

def bias_variable(shape, n=""):
    initial = tf.constant(0.1, shape=shape, name=n)
    return tf.Variable(initial)
...
with tf.name_scope("Wx_b") as scope:
    ...
    with tf.name_scope("Layer 1") as sub_scope1:
    ...
    with tf.name_scope("Layer 2") as sub_scope2:
...
with tf.name_scope("Cost Function") as scope:
